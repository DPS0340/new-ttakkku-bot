...
const ownerID = '309230935377707011' //put your ID here if selfhosting.
...
if(input === prefix + "시작" && isPlaying == false) {
...
//Bot login.
bot.login('').catch((err) => console.log(`[Client] Failed to connect: ${err.message}`))
